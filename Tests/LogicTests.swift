...
//
// A full XCTest target needs an Xcode project or Swift package; until then this covers
// the units most likely to break silently: date parsing, match state, stable task IDs,
// notch geometry, Zen formatting, and clipboard previews.
